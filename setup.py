#!/usr/bin/env python
"""
Package metadata for blogging_for_humans_3.
"""
import os
import re
import sys
...
VERSION = get_version('blogging_for_humans_3', '__init__.py')
...
setup(
    ...
    author_email='maciej.komorowski@opi.org.pl',
    url='https://github.com/openedx/blogging_for_humans3',
    packages=find_packages(
        include=['blogging_for_humans_3', 'blogging_for_humans_3.*'],
        exclude=["*tests"],
    ),
