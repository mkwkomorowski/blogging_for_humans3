...
"""
blogging_for_humans_3 documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'blogging_for_humans3',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/blogging_for_humans3",
...
#
# html_title = 'blogging_for_humans_3 v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'blogging_for_humans_3'),
                os.path.join(root_path, 'blogging_for_humans_3/migrations')])
